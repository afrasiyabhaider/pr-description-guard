# Recraft.ai Icon Generation Prompt

## Optimized Prompt for Recraft.ai
...
## Detailed Prompt (More Specific)

```
Create a minimalist Chrome extension icon, 128x128 pixels, flat design style. 
Shield shape with rounded top point as the base. 
...
## Step-by-Step: Using Recraft.ai

### Method 1: Single Generation

1. **Go to:** https://recraft.ai
2. **Select:** "Image Generation" or "Icon Generation"
3. **Paste this prompt:**
   ```
...
### Method 2: Layered Approach (Better Control)

**Step 1: Base Shield**
```
Flat design shield icon, rounded top point, yellow amber background #F0C36D, 
128x128 pixels, transparent background, minimalist style.
```
...
## Recraft.ai Specific Optimizations

### For Best Results in Recraft.ai:

1. **Use "Icon" or "Vector" style** - Better for flat designs
2. **Set aspect ratio to 1:1** - Square format
...
### Full Prompt with Negative Prompts:
...
**Negative Prompt:**
```
gradients, shadows, 3D, realistic, complex details, text, blur, 
photorealistic, depth, perspective, rounded edges on icon elements
```

---

## Element Breakdown for Recraft.ai
...
- Use Recraft.ai's background removal tool
- Or use https://www.remove.bg

### 2. Adjust Colors (if needed)
- Use Recraft.ai's edit tools
- Ensure exact colors:
  - Background: #F0C36D
  - Details: #735C0F
  - Checkmark: #FFFFFF
...
## Recraft.ai Settings Recommendations

### Image Generation Settings:
- **Style:** Icon / Vector / Flat Design
- **Aspect Ratio:** 1:1 (Square)
- **Resolution:** 1024x1024 (will scale to 128x128)
- **Quality:** High
- **Mode:** Icon/Logo mode if available

### Advanced Settings:
- **Remove Background:** Yes (transparent)
- **Simplify:** Yes (for small size clarity)
- **Color Palette:** Use exact hex codes if possible

---

## Quick Copy-Paste Prompt for Recraft.ai
...
**Negative Prompt:**
```
gradients, shadows, 3D effects, realistic, complex details, text, blur, 
photorealistic, depth, perspective
```
...
- Use Recraft.ai's color adjustment tools
- Regenerate with more specific color instructions

---

**Best Practice: Generate at high resolution (1024x1024) then scale down to ensure clarity at all sizes.**
